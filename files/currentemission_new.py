...
#                                 USER INPUTS                         
#####################################################################################################################################
Elec_df = pd.read_excel(r"C:\Users\wnspi\OneDrive\Desktop\myNode\files\Scaled data from Imported electricity- dan.xlsx")

district = input("Enter Your District: ").strip()
district = district.capitalize()

Solar1kWp_df = pd.read_excel(r"C:\Users\wnspi\OneDrive\Desktop\myNode\files\Monthly district solar average for 1kWp in kWh.xlsx",sheet_name = district)

roof_area = float(input("Rooftop Area with solarPV mounting capability: ").strip()) #m^2

diesel_consump = float(input("Annual Diesel Consumption (l): "))

Steam_demand = pd.read_excel(r"C:\Users\wnspi\OneDrive\Desktop\myNode\files\Scaled steam demand data.xlsx")
