    ...
    return (
        <div className='center' style={{backgroundColor: "#E6E6FA" }}>
            <form>
                ...
                <h2>Reducing Emissions in Your Factory: Effective Strategies for Sustainability</h2>

                <center><h3>Energy Efficiency Improvements </h3></center>
                <p>Maximize emission reductions achieve substantial emission reductions by enhancing energy efficiency throughout your operations. Our experts recommend the following measures to optimize your energy consumption:</p>
                <ul>            
